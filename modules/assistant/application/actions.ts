...
import { generateWorkspaceAssistantResult, isAIDraftConfigured } from '@/modules/ai/application/drafts';
import {
...
import type { WorkspaceAssistantResult } from '@/modules/ai/domain/draft-types';
