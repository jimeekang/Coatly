...
import { generateWorkspaceDraft, isAIDraftConfigured } from '@/modules/ai/application/drafts';
import type {
  WorkspaceDraftEntity,
  WorkspaceDraftResult,
} from '@/modules/ai/domain/draft-types';
import type { MaintenanceJobPackId, QuoteJobType } from '@/modules/quotes/domain/quote';
import {
