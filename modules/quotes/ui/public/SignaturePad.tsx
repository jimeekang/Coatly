...
export function SignaturePad({ value, onChange, disabled }: SignaturePadProps) {
  ...
  return (
    <div className="space-y-3">
      {/* Tab switcher */}
      <div className="flex gap-1 rounded-xl border border-outline bg-surface-container-low p-1">
          ...
          <div
            className={[
              ...
              disabled
                ...
                : 'border-dashed border-outline hover:border-primary-container/60',
            ].join(' ')}
          >
            <canvas
              ref={canvasRef}
      ...
      {tab === 'upload' && (
        <div className="space-y-2">
          {uploadPreview ? (
            ...
            <label
              className={[
                'flex min-h-28 cursor-pointer flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-outline bg-surface-container-low transition-colors',
                disabled ? 'cursor-not-allowed opacity-60' : 'hover:border-primary-container hover:bg-success-container',
              ].join(' ')}
            >
              ...
              <span className="text-sm font-medium text-on-surface-variant">Click to upload signature</span>
              <span className="text-xs text-on-surface-variant">PNG, JPG, GIF</span>
