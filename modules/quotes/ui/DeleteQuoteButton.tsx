          ...
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="mt-5 flex flex-col gap-2.5">
              <button
                ...
                disabled={isPending}
                className="inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-error px-4 py-3 text-sm font-semibold text-on-error transition-colors hover:bg-error/90 disabled:opacity-60"
              >
                {isPending ? (
                  <>
                    <svg
