...
export default function PublicQuoteError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[PublicQuoteError]', error);
  }, [error]);

  return (
    <div className="flex min-h-[60dvh] flex-col items-center justify-center gap-4 px-6 text-center">
      <ErrorAlert className="max-w-md">
        Something went wrong loading this quote. Please try again.
      </ErrorAlert>
      <button
        type="button"
        onClick={reset}
