...
export default function MaterialsServiceError({ error, reset }: ErrorProps) {
  useEffect(() => {
    console.error('[MaterialsServiceError]', error);
  }, [error]);

  return (
    <div className="flex min-h-[60dvh] flex-col items-center justify-center gap-4 px-6 text-center">
      <ErrorAlert className="max-w-md">
        Something went wrong loading your materials and services. Your data is safe — please try again.
      </ErrorAlert>
      <button
        type="button"
        onClick={reset}
