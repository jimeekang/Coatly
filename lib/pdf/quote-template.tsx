...
import type { QuoteWithCustomer } from '@/types/quote';
    ...
    <Document>
      <Page size="A4" style={styles.page}>
              ...
              {room.surfaces.map((surface) => (
                <View key={surface.id} style={styles.tableRow}>
                  ...
                  <Text style={[styles.col3, { color: '#6b7280' }]}>
                    {formatAUD(surface.rate_per_sqm)}/m²
                  </Text>
                  <Text style={[styles.col4, { color: '#6b7280' }]}>
                    {formatAUD(surface.price_cents)}
                  </Text>
                </View>
              ))}
            </View>
        ...
        <Text style={styles.footer}>
          Generated by PaintMate · paintmate.com.au · This quote is valid until{' '}
